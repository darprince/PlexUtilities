...
interface MediaInfoLibrary extends Library {
    ...
    MediaInfoLibrary INSTANCE = (MediaInfoLibrary) Native.loadLibrary(
            "./src/main/java/com/dprince/plex/shared/jnaMediaMetaDataEditor/mediaInfo-1.0.dll",
     ...
     *         is a problem
     */
    WString GetI(Pointer handle, int streamKind, int streamNumber, int parameterIndex,
            int infoKind);
